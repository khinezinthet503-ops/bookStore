...
function createSlot(name = "default", rawProps, fallback, flags = 0) {
	...
	if (interopSlotsSource) {
		...
		const getBoundSlot = (slot) => {
			if (slot !== cachedSlot) {
				cachedSlot = slot;
				cachedBoundSlot = () => renderWithSlotScopeIds(slotScopeIds, () => once ? withOnce(() => slot(slotProps)) : slot(slotProps));
			}
...
//#endregion
export { setDOMProp as $, TriggerOpTypes as $a, resolveDirective as $i, createHydrationRenderer as $n, isMismatchAllowed as $r, useHost as $t, createVaporApp as A, useSlots as Aa, onUnmounted as Ai, Static as An, normalizeClass as Ao, getInheritedScopeIds as Ar, defineSSRCustomElement as At, insert as B, watch as Ba, provide as Bi, callWithAsyncErrorHandling as Bn, initCustomFormatter as Br, normalizeContainer as Bt, createInvoker as C, unregisterHMR as Ca, onBeforeUpdate as Ci, ErrorTypeStrings as Cn, toRefs as Co, filterModelListeners as Cr, VueElementBase as Ct, createSlot as D, useInstanceOption as Da, onRenderTracked as Di, MoveType as Dn, camelize as Do, getContainerType as Dr, createApp as Dt, createSelector as E, useId as Ea, onMounted as Ei, MismatchTypes as En, unref as Eo, getComponentName as Er, callPendingCbs as Et, defineVaporSSRCustomElement as F, vdomSlotFallbackKey as Fa, performTransitionLeave as Fi, activate as Fn, hasInjectionContext as Fr, handleMovedChildren as Ft, on as G, withCtx as Ga, queuePostRenderEffect as Gi, computed as Gn, isAsyncWrapper as Gr, resolveTransitionProps as Gt, isVaporComponent as H, watchPostEffect as Ha, pushWarningContext as Hi, checkTransitionMode as Hn, inject as Hr, patchProp as Ht, delegate as I, version as Ia, popScopeId as Ii, assertNumber as In, hydrateOnIdle as Ir, hasCSSTransform as It, renderEffect as J, withMemo as Ja, registerRuntimeCompiler as Ji, createBaseVNode as Jn, isHydrating as Jr, shouldSetAsPropForVueCE as Jt, onBinding as K, withDefaults as Ka, rawVaporSlotKey as Ki, createAppAPI as Kn, isEmitListener as Kr, setVarsOnNode as Kt, delegateEvents as L, warn as La, popWarningContext as Li, baseEmit as Ln, hydrateOnInteraction as Lr, hydrate as Lt, defineVaporAsyncComponent as M, useTransitionState as Ma, openBlock as Mi, Teleport as Mn, normalizeStyle as Mo, guardReactiveProps as Mr, ensureRenderer as Mt, defineVaporComponent as N, validateComponentName as Na, performAsyncHydrate as Ni, Text$1 as Nn, toDisplayString as No, h as Nr, forceReflow as Nt, createTemplateRefSetter as O, useModel as Oa, onRenderTriggered as Oi, NULL_DYNAMIC_COMPONENT as On, capitalize as Oo, getCurrentInstance as Or, createSSRApp as Ot, defineVaporCustomElement as P, validateProps as Pa, performTransitionEnter as Pi, VaporSlot as Pn, toHandlerKey as Po, handleError as Pr, getValue as Pt, setClassName as Q, TrackOpTypes as Qa, resolveComponent as Qi, createElementBlock as Qn, isMemoSame as Qr, useCssVars as Qt, getDefaultValue as R, warnExtraneousAttributes as Ra, prepareTransitionLeave as Ri, baseNormalizePropsOptions as Rn, hydrateOnMediaQuery as Rr, initDirectivesForSSR as Rt, createIf as S, transformVNodeArgs as Sa, onBeforeUnmount as Si, ErrorCodes as Sn, toRef as So, expose as Sr, VueElement as St, createPlainElement as T, useAttrs as Ta, onErrorCaptured as Ti, KeepAlive as Tn, triggerRef as To, getAttributeMismatch as Tr, baseUseCssVars as Tt, next as U, watchSyncEffect as Ua, queueJob as Ui, cloneVNode as Un, invalidateMount as Ur, patchStyle as Ut, isFragment as V, watchEffect as Va, pushScopeId as Vi, callWithErrorHandling as Vn, initFeatureFlags as Vr, parseEventName as Vt, nthChild as W, withAsyncContext as Wa, queuePostFlushCb as Wi, compatUtils as Wn, invokeDirectiveHook as Wr, render as Wt, setBlockKey as X, EffectScope as Xa, renderSlot as Xi, createCanSetSetupRefChecker as Xn, isKeepAlive as Xr, unsafeToTrustedHTML as Xt, setAttr as Y, withScopeId as Ya, renderList as Yi, createBlock as Yn, isHydratingEnabled as Yr, svgNS as Yt, setClass as Z, ReactiveEffect as Za, resetShapeFlag as Zi, createCommentVNode as Zn, isMapEqual as Zr, useCssModule as Zt, createComponent as _, ssrUtils as _a, nextUid as _i, xlinkNS as _n, shallowReactive as _o, devtools as _r, withVaporKeys as _t, VaporKeepAlive as a, resolveTransitionHooks$1 as aa, isTemplateRefKey as ai, vModelRadio as an, isProxy as ao, createTextVNode as ar, setProp as at, createFor as b, toHandlers as ba, onActivated as bi, Comment$1 as bn, stop as bo, ensureValidVNode as br, TransitionGroup as bt, VaporTransitionGroup as c, setCurrentInstance as ca, knownTemplateRefs as ci, vModelSetSelected as cn, isRef as co, deactivate as cr, setTemplateRefBinding as ct, applyRadioModel as d, setIsHydratingEnabled$1 as da, markAsyncBoundary as di, vModelTextUpdate as dn, onScopeDispose as do, defineEmits as dr, template as dt, resolveDynamicComponent as ea, isRuntimeOnly as ei, useShadowRoot as en, customRef as eo, createInternalObject as er, setDynamicEvents as et, applySelectModel as f, setRef as fa, matches as fi, vShow as fn, onWatcherCleanup as fo, defineExpose as fr, txt as ft, createAssetComponent as g, ssrContextKey as ga, nextTick as gi, withModifiers as gn, ref as go, defineSlots as gr, withVaporDirectives as gt, child as h, simpleSetCurrentInstance as ha, mergeProps as hi, withKeys as hn, readonly as ho, defineProps as hr, withOnce as ht, VaporFragment as i, resolveTransitionChild as ia, isTemplateNode as ii, vModelDynamic as in, getCurrentWatcher as io, createStaticVNode as ir, setInsertionState as it, createVaporSSRApp as j, useTemplateRef as ja, onUpdated as ji, Suspense as jn, normalizeProps as jo, getTransitionRawChildren as jr, ensureHydrationRenderer as jt, createTextNode as k, useSSRContext as ka, onServerPrefetch as ki, SchedulerJobFlags as kn, extend as ko, getFunctionalFallthrough as kr, defineCustomElement as kt, applyCheckboxModel as l, setCurrentRenderingInstance as la, leaveCbKey as li, vModelText as ln, isShallow as lo, defineAsyncComponent as lr, setText as lt, applyVShow as m, shouldUpdateComponent as ma, mergeModels as mi, vShowOriginalDisplay as mn, reactive as mo, defineOptions as mr, vaporInteropPlugin as mt, DynamicFragment as n, resolvePropValue as na, isTeleportDeferred as ni, vModelCheckboxInit as nn, effectScope as no, createRenderer as nr, setElementText as nt, VaporTeleport as o, restoreCurrentInstance as oa, isVNode as oi, vModelSelect as on, isReactive as oo, createVNode as or, setStaticTemplateRef as ot, applyTextModel as p, setTransitionHooks as pa, mergeDefaults as pi, vShowHidden as pn, proxyRefs as po, defineModel as pr, useVaporCssVars as pt, remove as q, withDirectives as qa, registerHMR as qi, createAsyncComponentContext as qn, isFunctionalFallthroughKey as qr, shouldSetAsProp as qt, VaporElement as r, resolveTarget as ra, isTeleportDisabled as ri, vModelCheckboxUpdate as rn, getCurrentScope as ro, createSlots as rr, setHtml as rt, VaporTransition as s, setBlockTracking as sa, isValidHtmlOrSvgAttribute as si, vModelSelectInit as sn, isReadonly as so, currentInstance as sr, setStyle as st, compile as t, resolveFilter as ta, isSetEqual as ti, vModelCheckbox as tn, effect as to, createPropsRestProxy as tr, setDynamicProps as tt, applyDynamicModel as u, setDevtoolsHook as ua, logMismatchError as ui, vModelTextInit as un, markRaw as uo, defineComponent as ur, setValue as ut, createComponentWithFallback as v, startMeasure as va, normalizeRef as vi, BaseTransition as vn, shallowReadonly as vo, devtoolsComponentAdded as vr, withVaporModifiers as vt, createKeyedFragment as w, useAsyncComponentState as wa, onDeactivated as wi, Fragment as wn, toValue as wo, flushOnAppMount as wr, baseApplyTranslation as wt, createForSlots as x, toStyleMap as xa, onBeforeMount as xi, DeprecationTypes as xn, toRaw as xo, ensureVaporSlotFallback as xr, TransitionPropsValidators as xt, createDynamicComponent as y, toClassSet as ya, normalizeVNode as yi, BaseTransitionPropsValidators as yn, shallowRef as yo, endMeasure as yr, Transition as yt, getRestElement as z, warnPropMismatch as za, prepareTransitionSwitch as zi, baseResolveTransitionHooks as zn, hydrateOnVisible as zr, nodeOps as zt };
